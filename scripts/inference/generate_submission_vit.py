#!/usr/bin/env python3
"""
Generate submission CSV file for fire detection task using ViT model.
...
def main():
    """Main function."""
    parser = argparse.ArgumentParser(description='Generate submission CSV file for ViT model')
    parser.add_argument(
        '--checkpoint',
        type=str,
        default=None,
