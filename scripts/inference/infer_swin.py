...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description='Swin Transformer Inference Script')
    parser.add_argument(
        '--checkpoint',
        type=str,
        default=None,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Output directory for results (default: results/swin from config)'
    )
    ...
    if test_dir.exists() and test_dir.is_dir():
        ...
        # 如果没有独立的测试集，从训练数据中划分
        logger.info("No dedicated test set found, using validation split from training data")
